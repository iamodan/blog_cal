...
//		String encPassword = new BCryptPasswordEncoder().encode("1234");
    ...
    @Bean
    public AuthenticationManager authenticationManager(HttpSecurity http, BCryptPasswordEncoder bCryptPasswordEncoder, PrincipalDetailService userDetailService) 
      throws Exception {
 ...
 */
            ...
            .formLogin(formLogin -> formLogin
                    ...
                    .loginProcessingUrl("/auth/loginProc") // 추가한 부분
